...
export const Home = () => {
  ...
  return (
    <div
      ref={gridRef}
      className="relative flex min-h-screen items-center justify-center gap-20 overflow-hidden bg-bg px-10 py-15 font-display max-[900px]:flex-col max-[900px]:items-start max-[900px]:gap-10 max-[900px]:px-6 max-[900px]:py-10"
    >
      ...
      <div className="z-1 flex max-w-120 animate-fade-up flex-col gap-7">
        <div className="flex w-fit items-center gap-2 rounded-full border border-accent/15 bg-accent/6 px-3.5 py-1.5 font-mono text-[11px] tracking-[0.08em] text-accent">
          <span className="size-1.5 animate-blink rounded-full bg-accent" />
          <span>Automação Super TM</span>
        </div>

        <h1 className="m-0 flex items-baseline gap-4 leading-none">
          <span className="text-[88px] font-extrabold tracking-[-0.04em] text-content max-[900px]:text-[64px]">
            Super
          </span>
          <span className="text-[88px] font-extrabold tracking-[-0.04em] text-accent [text-shadow:0_0_40px_rgba(0,229,255,0.4)] max-[900px]:text-[64px]">
            TM
          </span>
        </h1>
      ...
      <div className="z-1 w-75 animate-fade-up overflow-hidden rounded-xl border border-line-soft bg-surface font-mono text-xs shadow-[0_24px_64px_rgba(0,0,0,0.4)] [animation-delay:0.15s] max-[900px]:w-full">
