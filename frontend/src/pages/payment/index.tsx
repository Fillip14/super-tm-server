...
export const Payment = () => {
  ...
  return (
    ...
    >
      <main className="relative z-1 flex justify-center px-6 py-12 max-[640px]:px-4 max-[640px]:py-8">
        <div className="w-full max-w-110 animate-card-in rounded-[20px] border border-line bg-surface px-10 py-12 text-center shadow-[0_32px_80px_rgba(0,0,0,0.5)] max-[640px]:px-6 max-[640px]:py-8">
          {success ? (
